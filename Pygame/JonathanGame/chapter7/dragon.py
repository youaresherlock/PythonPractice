...
class MySprite(pygame.sprite.Sprite):
    ...
    def __init__(self, target):
        ...
        # py2 super(MySprite, self).__init__()
        # python3
        super().__init__()
    ...
    # rate is the rate milliseconds for holding the current frame sprite
...
pygame.init()
"""
pygame.display.set_mode(size=(0,0), flags=0, depth=0, diplay=0) -> Surface
The size argument is a pair of numbers representing the width and height.
The flags argument is a collection of additional options. 
